...
## TL;DR
  ...
  - **v0.1.0 tagged** — release workflow building 5 platforms (macOS arm64+x64, Linux arm64+x64, Windows x64)
  - **One-line install**: `curl -LsSf https://github.com/ramazanayyildiz/agentbus/releases/latest/download/agentbus-installer.sh | sh`
